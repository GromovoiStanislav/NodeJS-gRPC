...
export var weather;
(function (weather) {
    class City extends pb_1.Message {
        #one_of_decls = [];
        constructor(data) {
            super();
    ...
    weather.City = City;
    class Temperature extends pb_1.Message {
        #one_of_decls = [];
        constructor(data) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
    ...
    class CityQuery extends pb_1.Message {
        #one_of_decls = [];
        constructor(data) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
    ...
    })(CityQuery = weather.CityQuery || (weather.CityQuery = {}));
    class GetTemperature extends pb_1.Message {
        #one_of_decls = [];
        constructor(data) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
    ...
    class Ping extends pb_1.Message {
        #one_of_decls = [];
        constructor(data) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
    ...
    (function (Ping) {
        ...
        Ping.Ack = Ack;
    })(Ping = weather.Ping || (weather.Ping = {}));
    class Forecast extends pb_1.Message {
        #one_of_decls = [];
        constructor(data) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
    ...
    class UnimplementedWeatherService {
        static definition = {
            cities: {
    ...
    weather.UnimplementedWeatherService = UnimplementedWeatherService;
    class WeatherClient extends grpc_1.makeGenericClientConstructor(UnimplementedWeatherService.definition, "Weather", {}) {
