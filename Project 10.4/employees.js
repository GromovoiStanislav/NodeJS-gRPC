exports.encodeEmployee = function (message) {
...
exports.decodeEmployee = function (binary) {
...
exports.encodeEmployees = function (message) {
  var bb = popByteBuffer();
...
function _encodeEmployees(message, bb) {
  ...
  var array$employees = message.employees;
  if (array$employees !== undefined) {
    for (var i = 0; i < array$employees.length; i++) {
      var value = array$employees[i];
      writeVarint32(bb, 10);
...
exports.decodeEmployees = function (binary) {
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      case 1: {
        ...
        var values = message.employees || (message.employees = []);
